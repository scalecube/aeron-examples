...
public final class MdcRecordingPublisher {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    Publication publication = aeron.addExclusivePublication(publicationChannel.build(), STREAM_ID);
  ...
  private static void setup(boolean cleanStart) {
    ...
    aeron =
        Aeron.connect(
            new Aeron.Context().aeronDirectoryName(mediaDriverContext.aeronDirectoryName()));
